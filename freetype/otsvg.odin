...
Ft_Error :: proc "c" (data_pointer: ^i32, SVG_Lib_Init_Func: ^i32) -> proc "c" (^i32) -> i32
...
*   2.12
*/
Svg_Lib_Free_Func :: proc "c" (data_pointer: ^i32)
...
*   2.12
*/
Svg_Lib_Render_Func :: proc "c" (i32, ^i32) -> i32
...
*   2.12
*/
Svg_Lib_Preset_Slot_Func :: proc "c" (i32, i32, ^i32) -> i32
...
*   2.12
*/
Ft_Svg_Document :: ^Ft_Svg_Document_Rec
